...
public class DocumentController {
	...
	public ResponseEntity<String> saveDocumentUsingRegID(@PathVariable Integer registrationId,
		...
		documentService.saveDocumentUsingRegID(registrationId,adharCard,panCard,photo,sign,salarySlip,itr,bankPass,incomeCertificate,propertyDocument,guarantorSign,guarantorBankPass,doc);
