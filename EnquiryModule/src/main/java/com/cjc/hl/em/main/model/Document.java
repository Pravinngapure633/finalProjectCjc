...
public class Document {
	...
	public Document(Integer documentId, Integer registrationId, byte[] adharCard, byte[] panCard, byte[] photo,
			byte[] sign, byte[] salarySlip, byte[] iTR, byte[] bankPass, byte[] incomeCertificate,
			byte[] propertyDocument, byte[] guarantorSign, byte[] guarantorBankPass) {
		super();
		this.documentId = documentId;
		this.registrationId = registrationId;
		this.adharCard = adharCard;
	...
	public String toString() {
		return "Document [documentId=" + documentId + ", registrationId=" + registrationId + ", adharCard="
				+ Arrays.toString(adharCard) + ", panCard=" + Arrays.toString(panCard) + ", photo="
				+ Arrays.toString(photo) + ", sign=" + Arrays.toString(sign) + ", salarySlip="
				+ Arrays.toString(salarySlip) + ", iTR=" + Arrays.toString(iTR) + ", bankPass="
